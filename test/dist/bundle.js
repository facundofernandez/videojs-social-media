...
var Icon = function () {
  ...
  _createClass(Icon, [{
    ...
    value: function toSvg() {
      ...
      var combinedAttrs = _extends({}, this.attrs, attrs, { class: (_dedupe2.default)(this.attrs.class, attrs.class) });
...
function replaceElement(element) {
  ...
  var svgString = _icons2.default[name].toSvg(_extends({}, attrs, elementAttrs, { class: (_dedupe2.default)(attrs.class, elementAttrs.class) }));
...
var onPlayerReady = function onPlayerReady(player, options) {
  ...
  button.addEventListener('click', function (e) {
    ...
    var el = document_1.querySelector('.vjs-menu-social');
  ...
  for (var _iterator = Object.keys(socialItems), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
    ...
    var opt = lodash.merge({ name: socialType }, socialItems[socialType]);
...
QUnit.test('the environment is sane', function (assert) {
  ...
  assert.strictEqual(typeof socialMedia === 'undefined' ? 'undefined' : _typeof(socialMedia), 'function', 'plugin is a function');
});
...
QUnit.test('registers itself with video.js', function (assert) {
  ...
  assert.strictEqual(_typeof(Player.prototype.socialMedia), 'function', 'videojs-social-media plugin was registered');
  ...
  assert.ok(this.player.hasClass('vjs-social-media'), 'the plugin adds a class to the player');
});
